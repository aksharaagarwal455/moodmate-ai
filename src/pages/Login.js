    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-submit { width: 100%; background: linear-gradient(135deg, #7c3aed, #ec4899); border: none; color: white; padding: 15px; border-radius: 12px; font-family: 'Nunito', sans-serif; font-size: 1rem; font-weight: 700; cursor: pointer; transition: all 0.25s; margin-top: 4px; box-shadow: 0 8px 24px rgba(124,58,237,0.35); }
        ...
        .auth-switch-link:hover { color: #c4b5fd; transform: none !important; }
      ...
      <div className="auth-root">
        ...
        <div className="auth-right">
          ...
          <p className="auth-switch">
            No account?
            <button className="auth-switch-link" type="button" onClick={() => navigate('/signup')}>Create one free</button>
          </p>
        </div>
      </div>
    </>
