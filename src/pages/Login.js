  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Show exact error from backend (wrong password, not found, etc.)
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-left {
          ...
          padding: 60px;
          background: linear-gradient(145deg, #1a0533 0%, #0d0d1a 60%, #1a1040 100%);
        }
        ...
        .auth-left-h {
          ...
          color: #f0eeff; margin-bottom: 20px;
        }
        .auth-left-h span {
        ...
        .auth-left-sub { font-size: 1rem; color: rgba(240,238,255,0.45); line-height: 1.7; font-weight: 400; }

        .auth-right {
          width: 460px; background: #13131f;
        ...
        .auth-form-title {
          font-family: 'Syne', sans-serif; font-size: 1.6rem; font-weight: 800;
          color: #f0eeff; margin-bottom: 6px; width: 100%;
        }
        ...
        .auth-field-label {
          ...
          text-transform: uppercase; color: rgba(240,238,255,0.4);
          display: block; margin-bottom: 8px;
        }

        .auth-input {
          width: 100%; background: rgba(255,255,255,0.04);
          border: 1px solid rgba(255,255,255,0.09); color: #f0eeff;
        ...
        .auth-error {
          ...
          color: #fca5a5; padding: 10px 14px; border-radius: 10px; font-size: 0.85rem;
        }
        ...
        .auth-switch-link {
          color: #a78bfa; cursor:pointer; font-weight:700;
          background:none; border:none; font-family:'Nunito',sans-serif;
          font-size:0.88rem; padding:0; margin-left:4px; text-decoration:underline; text-underline-offset:3px;
        }
      ...
      <div className="auth-root">
        <div className="auth-left">
          ...
          <div className="auth-left-content">
            ...
            <h2 className="auth-left-h">Your mood.<br /><span>Your music.</span></h2>
            <p className="auth-left-sub">AI that understands how you feel and curates the perfect soundtrack for every moment.</p>
          </div>
        </div>
        <div className="auth-right">
          <div className="auth-form-title">Welcome back</div>
          <div className="auth-form-sub">Sign in to continue to MoodMate</div>
          <form className="auth-form" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <input className="auth-input" type="password" placeholder="Your password" value={password} onChange={e=>setPassword(e.target.value)} required />
            </div>
          ...
          <p className="auth-switch">No account?<button className="auth-switch-link" onClick={()=>navigate('/signup')}>Create one free</button></p>
        </div>
      </div>
    </>
  );
